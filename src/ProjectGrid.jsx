...
function ProjectGrid({ projects, variant = 'dark' }) {
  ...
  return (
    <div className="relative grid grid-cols-1 gap-2 py-4 sm:grid-cols-4">
      ...
      {selectedProject && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#0000005d] p-4"
          onClick={() => setSelectedProject(null)}
        >
          <div
            className="relative flex min-h-[60%] w-full max-w-2xl flex-col items-center justify-center rounded-xl bg-[#E7FDF6] p-6"
